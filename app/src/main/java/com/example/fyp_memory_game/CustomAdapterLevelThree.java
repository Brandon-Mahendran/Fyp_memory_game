...
public class CustomAdapterLevelThree extends BaseAdapter {
    ...
    public CustomAdapterLevelThree(Context context,ArrayList<String> Id,ArrayList<String> Name,ArrayList<String> Score){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder = (CustomAdapterLevelThree.viewHolder) convertView.getTag();
        }
