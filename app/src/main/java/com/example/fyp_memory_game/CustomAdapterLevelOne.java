...
public class CustomAdapterLevelOne extends BaseAdapter {
    ...
    public CustomAdapterLevelOne(Context context,ArrayList<String> Id,ArrayList<String> Name,ArrayList<String> Score){
