...
public class CustomAdapterLevelFour extends BaseAdapter {
    ...
    public CustomAdapterLevelFour(Context context,ArrayList<String> Id,ArrayList<String> Name,ArrayList<String> Score){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder = (CustomAdapterLevelFour.viewHolder) convertView.getTag();
        }
