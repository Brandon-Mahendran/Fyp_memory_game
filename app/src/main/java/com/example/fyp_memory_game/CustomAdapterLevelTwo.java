...
public class CustomAdapterLevelTwo extends BaseAdapter {
    ...
    public CustomAdapterLevelTwo(Context context,ArrayList<String> Id,ArrayList<String> Name,ArrayList<String> Score){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder = (CustomAdapterLevelTwo.viewHolder) convertView.getTag();
        }
