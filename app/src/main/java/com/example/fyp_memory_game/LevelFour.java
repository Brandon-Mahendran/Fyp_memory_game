...
public class LevelFour extends AppCompatActivity {
    ...
    //array for images
    Integer[] cardArray = {101,102,103,104,105,106,107,
    ...
    private void checkEnd(){
        if(iv_11.getVisibility()==View.INVISIBLE &&
            ...
            AlertDialog.Builder mBuilder = new AlertDialog.Builder(LevelFour.this);
            ...
            btn_no_nextlvl.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    startActivity(new Intent(LevelFour.this,MainActivity.class));
                    finish();
                }
            });
            ...
            //add here
            boolean isInserted = myDb.insertData_levelfour(
                    s1,
                    String.valueOf(seconds));

            if(isInserted == true){
                Toast.makeText(LevelFour.this,"Data Inserted",Toast.LENGTH_LONG).show();
            }else{
                Toast.makeText(LevelFour.this,"Data not Inserted",Toast.LENGTH_LONG).show();
            }
