...
public class LevelSix extends AppCompatActivity {
    ...
    ImageView iv_11, iv_12 , iv_13 , iv_14, iv_15, iv_16, iv_17, iv_18, iv_19, iv_20,
            iv_21, iv_22 , iv_23 , iv_24, iv_25, iv_26, iv_27, iv_28, iv_29, iv_30;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hintbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(iv_17.getVisibility()==View.VISIBLE){
                    iv_17.performClick();
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            //check weather selected image are same
                            iv_17.setImageResource(R.drawable.cardcover);
                        }
                    },1000);
                }

                if(iv_18.getVisibility()==View.VISIBLE){
                    iv_18.performClick();
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            //check weather selected image are same
                            iv_18.setImageResource(R.drawable.cardcover);
                        }
                    },1000);
                }

                if(iv_19.getVisibility()==View.VISIBLE){
                    iv_19.performClick();
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            //check weather selected image are same
                            iv_19.setImageResource(R.drawable.cardcover);
                        }
                    },1000);
                }

                if(iv_20.getVisibility()==View.VISIBLE){
                    iv_20.performClick();
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            //check weather selected image are same
                            iv_20.setImageResource(R.drawable.cardcover);
                        }
                    },1000);
                }
                ...
                if(iv_27.getVisibility()==View.VISIBLE){
                    iv_27.performClick();
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            //check weather selected image are same
                            iv_27.setImageResource(R.drawable.cardcover);
                        }
                    },1000);
                }

                if(iv_28.getVisibility()==View.VISIBLE){
                    iv_28.performClick();
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            //check weather selected image are same
                            iv_28.setImageResource(R.drawable.cardcover);
                        }
                    },1000);
                }

                if(iv_29.getVisibility()==View.VISIBLE){
                    iv_29.performClick();
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            //check weather selected image are same
                            iv_29.setImageResource(R.drawable.cardcover);
                        }
                    },1000);
                }

                if(iv_30.getVisibility()==View.VISIBLE){
                    iv_30.performClick();
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            //check weather selected image are same
                            iv_30.setImageResource(R.drawable.cardcover);
                        }
                    },1000);
                }
            }
    ...
    private void checkEnd(){
        if(iv_11.getVisibility()==View.INVISIBLE &&
            ...
            AlertDialog.Builder mBuilder = new AlertDialog.Builder(LevelSix.this);
            ...
            //add here
            boolean isInserted = myDb.insertData_levelsix(
                    s1,
                    String.valueOf(seconds));

            if(isInserted == true){
                Toast.makeText(LevelSix.this,"Data Inserted",Toast.LENGTH_LONG).show();
            }else{
                Toast.makeText(LevelSix.this,"Data not Inserted",Toast.LENGTH_LONG).show();
            }
    ...
    private void frontOfCardsResources() {
        ...
        image102 = R.drawable.library;
        image103 = R.drawable.muzium;
        image104 = R.drawable.dataranperdana;
        image105 = R.drawable.managercoffee;
        image106 = R.drawable.canselori;
        image107 = R.drawable.uassist;
        image108 = R.drawable.pusatsukan;
        image109 = R.drawable.fountaincenselori;
        image110 = R.drawable.datarancenselori;

        image201 = R.drawable.dmas;
        image202 = R.drawable.library;
        image203 = R.drawable.muzium;
        image204 = R.drawable.dataranperdana;
        image205 = R.drawable.managercoffee;
        image206 = R.drawable.canselori;
        image207 = R.drawable.uassist;
        image208 = R.drawable.pusatsukan;
        image209 = R.drawable.fountaincenselori;
        image210 = R.drawable.datarancenselori;
    }
