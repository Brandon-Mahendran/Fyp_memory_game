...
public class CustomAdapterLevelFive extends BaseAdapter {
    ...
    public CustomAdapterLevelFive(Context context,ArrayList<String> Id,ArrayList<String> Name,ArrayList<String> Score){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder = (CustomAdapterLevelFive.viewHolder) convertView.getTag();
        }
