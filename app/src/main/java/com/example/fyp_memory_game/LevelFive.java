...
public class LevelFive extends AppCompatActivity {
    ...
    ImageView iv_11, iv_12 , iv_13 , iv_14, iv_15, iv_16, iv_17, iv_18, iv_19,
            iv_21, iv_22 , iv_23 , iv_24, iv_25, iv_26, iv_27, iv_28, iv_29;

    //array for images
    Integer[] cardArray = {101,102,103,104,105,106,107,108,109,
    ...
    private void checkEnd(){
        if(iv_11.getVisibility()==View.INVISIBLE &&
            ...
            AlertDialog.Builder mBuilder = new AlertDialog.Builder(LevelFive.this);
            ...
            //add here
            boolean isInserted = myDb.insertData_levelfive(
                    s1,
                    String.valueOf(seconds));

            if(isInserted == true){
                Toast.makeText(LevelFive.this,"Data Inserted",Toast.LENGTH_LONG).show();
            }else{
                Toast.makeText(LevelFive.this,"Data not Inserted",Toast.LENGTH_LONG).show();
            }
